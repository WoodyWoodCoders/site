    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form id="formDeleteClient" action="index.php?p=client&a=crud" method="post">
                    <input type="hidden" name="action" value="deleteClient">
                    <input type="hidden" name="id" value="<?php echo $client->getId() ?>">
                </form>
                <button type="submit" form="formDeleteClient" class="btn btn-danger"><i class="fa fa-close"></i></button>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
