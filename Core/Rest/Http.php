...
class Http
{
     ...
     * @return string
     */
    public function doPost($url, $params=array(), $json = true)
    {
        return $this->_exec(self::POST, $this->_url($url), $params, $json);
    }
     ...
     * @return string
     */
    public function doGet($url, $params=array(), $json = true)
    {
        return $this->_exec(self::GET, $this->_url($url), $params, $json);
    }
     ...
     * @return unknown
     */
    private function _url($url=null, $local = false)
    {
